...
describe("[Challenge] Unstoppable", function () {
  ...
  before(async function () {
    ...
    await token.approve(vault.address, TOKENS_IN_VAULT); // Here the token approves the UnstoppableVault
    await vault.deposit(TOKENS_IN_VAULT, deployer.address); // Here UnstoppableVault deposits Token
  ...
  it("Execution", async function () {
    ...
    // Player is transfer its DVT tokens into the Vault contract to cause an imbalance
